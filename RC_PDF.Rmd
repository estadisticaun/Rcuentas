...
author: "<i>Dirección Nacional de Planeación y Estadística</i>"
...
output: 
  bookdown::pdf_document2:
    ...
    toc: true
    includes:
      in_header: Contenido.tex
---


```{r setup, include=FALSE}
knitr::opts_chunk$set(echo = FALSE, fig.cap ='Fuente: Dirección Nacional de Planeación y Estadística', fig.show='hold')
```
...
knitr::include_graphics('Imagenes/Nube5000.png')
```
